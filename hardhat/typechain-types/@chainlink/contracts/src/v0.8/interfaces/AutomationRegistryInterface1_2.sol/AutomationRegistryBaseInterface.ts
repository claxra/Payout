...
export interface AutomationRegistryBaseInterfaceInterface
...
export interface AutomationRegistryBaseInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AutomationRegistryBaseInterfaceInterface;
